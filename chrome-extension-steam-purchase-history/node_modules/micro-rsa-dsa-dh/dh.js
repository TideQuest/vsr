...
exports.diffieHellman = exports.DH = exports.DHGroups = void 0;
const utils_1 = require("@noble/hashes/utils");
const utils_js_1 = require("./utils.js");
exports.DHGroups = {
    modp1: {
        p: BigInt('0xffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd1' +
...
const DH = (group) => {
    if (typeof group === 'string')
        group = exports.DHGroups[group];
    if (!group)
        throw new Error('DH: wrong group');
    const { p, g } = group;
    if (typeof p !== 'bigint' || typeof g !== 'bigint')
        throw new Error('DH: wrong group params');
    const bytesLen = (0, utils_js_1.getFieldBytesLength)(p);
    return {
        randomPrivateKey() {
            return (0, utils_js_1.mapHashToField)((0, utils_1.randomBytes)((0, utils_js_1.getMinHashLength)(p)), p);
        },
        getPublicKey(privateKey) {
            const privNum = (0, utils_js_1.bytesToNumber)((0, utils_js_1.ensureBytes)('private key', privateKey, bytesLen));
            const n = (0, utils_js_1.pow)(g, privNum, p); // g^privateKey mod p
            return (0, utils_js_1.numberToBytes)(n);
        },
        getSharedSecret(privateA, publicB) {
            const privNum = (0, utils_js_1.bytesToNumber)((0, utils_js_1.ensureBytes)('private key', privateA, bytesLen));
            const pubNum = (0, utils_js_1.bytesToNumber)((0, utils_js_1.ensureBytes)('public key', publicB, bytesLen));
            const n = (0, utils_js_1.pow)(pubNum, privNum, p); // publicB^privateA mod p
            return (0, utils_js_1.numberToBytes)(n, bytesLen);
        },
    };
};
exports.DH = DH;
exports.diffieHellman = exports.DH;
