...
// src/zkfetch.ts
var import_attestor_core = require("@reclaimprotocol/attestor-core");
...
var ATTESTOR_NODE_URL = "wss://attestor.reclaimprotocol.org/ws";
...
function assertCorrectnessOfOptions(options) {
  ...
  if (options.method !== "GET" /* GET */ && options.method !== "POST" /* POST */ && options.method !== "PUT" /* PUT */) {
...
var ReclaimClient = class {
  ...
  async zkFetch(url, options, secretOptions, retries = 1, retryInterval = 1e3) {
    ...
    while (attempt < retries) {
      try {
        const claim = await (0, import_attestor_core.createClaimOnAttestor)({
          name: "http",
          params: {
