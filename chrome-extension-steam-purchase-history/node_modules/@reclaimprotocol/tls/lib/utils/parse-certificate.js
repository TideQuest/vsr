...
require("./additional-root-cas");
const crypto_1 = require("../crypto");
const constants_1 = require("./constants");
const decryption_utils_1 = require("./decryption-utils");
const generics_1 = require("./generics");
const mozilla_root_cas_1 = require("./mozilla-root-cas");
...
async function verifyCertificateSignature({ signature, algorithm, publicKey, signatureData, }) {
    ...
    const pubKey = await crypto_1.crypto.importKey(cryptoAlg, publicKey.buffer, 'public');
...
function loadRootCAs() {
    ...
    ROOT_CAS = mozilla_root_cas_1.MOZILLA_ROOT_CA_LIST.map(x509_1.loadX509FromPem);
    if (typeof TLS_ADDITIONAL_ROOT_CA_LIST !== 'undefined') {
        ROOT_CAS.push(...TLS_ADDITIONAL_ROOT_CA_LIST.map(x509_1.loadX509FromPem));
    }
    return ROOT_CAS;
}
