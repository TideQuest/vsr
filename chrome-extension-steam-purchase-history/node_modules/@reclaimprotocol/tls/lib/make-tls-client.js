            ...
            while (data = readPacket()) {
                ...
                switch (type) {
                    case constants_1.SUPPORTED_RECORD_TYPE_MAP.SERVER_HELLO:
                        ...
                        const cipherSuiteData = constants_1.SUPPORTED_CIPHER_SUITE_MAP[cipherSuite];
                    ...
                    case constants_1.SUPPORTED_RECORD_TYPE_MAP.SERVER_HELLO_DONE:
                        ...
                        if (keyType === 'RSA') {
                            ...
                            const { preMasterSecret, encrypted } = await (0, key_share_1.createRsaPreMasterSecret)(certificates[0], connTlsVersion);
                            clientKeyShare = await (0, key_share_1.packClientRsaKeyShare)(encrypted);
                            ...
                            clientKeyShare
                                = await (0, key_share_1.packClientCurveKeyShare)(keyPairs[keyType].pubKey);
                        }
