...
export type SignatureAlgorithm = 'RSA-PSS-SHA256' | 'ECDSA-SECP384R1-SHA384' | 'ECDSA-SECP256R1-SHA256' | 'ED25519' | 'RSA-PKCS1-SHA512' | 'RSA-PKCS1-SHA384' | 'RSA-PKCS1-SHA256';
...
export type Crypto = {
    ...
    importKey(alg: AsymmetricCryptoAlgorithm | AsymmetricEncDecAlgorithm, raw: Uint8Array, type: 'private' | 'public'): Awaitable<Key>;
     ...
     */
    encrypt(cipherSuite: SymmetricCryptoAlgorithm | 'RSA-OAEP', opts: CryptOptions): Awaitable<Uint8Array>;
